...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (notificationTitle.equals("You have a new Message")) {
            ...
            if (!PersonalChats.running || PersonalChats.running && !PersonalChats.otherUserId.equals(notificationFrom)) {
                ...
                PendingIntent pendingIntent = PendingIntent.getActivity(this, notificationId % 65535,
            ...
            NotificationCompat.Builder notification = new NotificationCompat.Builder(this, getString(R.string.default_notification_channel_id))
                    .setContentTitle(notificationTitle)
                    .setContentText(notificationMessage)
                    .setSmallIcon(R.drawable.baseline_fiber_manual_record)
                    .setLargeIcon(BitmapFactory.decodeResource(getApplicationContext().getResources(), R.mipmap.ic_launcher_round))
                    .setAutoCancel(true)
                    .setDefaults(Notification.DEFAULT_LIGHTS | Notification.DEFAULT_SOUND | Notification.DEFAULT_VIBRATE);
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(this, notificationId + 1 % 65535, intent,
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(this, notificationId + 2 % 65535, intent,
                    PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE);
