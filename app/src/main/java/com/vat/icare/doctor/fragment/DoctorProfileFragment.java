...
import com.vat.icare.databinding.FragmentDoctorProfileBinding;
import com.vat.icare.doctor.DoctorMainActivity;
import com.vat.icare.doctor.EditProfileDoctor;
...
public class DoctorProfileFragment extends Fragment {
    ...
    DoctorMainActivity mainActivity;
    String currentUser;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        mContext = context;
        mainActivity = (DoctorMainActivity) context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.txtEditProfileDoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), EditProfileDoctor.class);
                startActivity(intent);
            }
        });

        binding.btnLogoutDoctor.setOnClickListener(view -> {
            ...
            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (user != null) {
                        ...
                        binding.txtDoctorName.setText(username);
                        binding.txtEmailIdDoctor.setText(email);
                        if(imgUser!=null){
                            byte[] imageAsBytes = Base64.decode(imgUser.getBytes(), Base64.DEFAULT);
                            binding.imgUserDoctor.setImageBitmap(BitmapFactory.decodeByteArray(imageAsBytes, 0, imageAsBytes.length));
                        }
                    }
                }
