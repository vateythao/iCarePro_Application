...
public class DoctorHolder extends RecyclerView.ViewHolder{
    ...
    public DoctorHolder(Activity activity, View view, Context context) {
        super(view);
    ...
    public void setHolder(String userid) {
        ...
        final TextView userName = view.findViewById(R.id.txtDocName);
        final TextView txtDocSpeciality = view.findViewById(R.id.txtDocSpeciality);
        final CircleImageView userImage = view.findViewById(R.id.imgDoct);
        ...
        userDatabase = FirebaseDatabase.getInstance().getReference().child("Doctors").child(userid);
        userListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try {
                    ...
                    final String speciality = dataSnapshot.child("speciality").getValue().toString();
